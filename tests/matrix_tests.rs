...
#[test]
fn test_arm64_probe_mappings_compile() {
    let _win = archinfo::arch::arm64::windows::WindowsArm64Probe::default();
    let lnx = archinfo::arch::arm64::linux::LinuxArm64Probe::default();
    let apple = archinfo::arch::arm64::apple::AppleArm64Probe::default();

    let mut f = archinfo::arch::arm64::Arm64CPUFeatures::default();

    // Linux probe field accesses matching detect_host
    ...
    // Apple probe field accesses matching detect_host
